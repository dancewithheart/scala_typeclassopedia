...
object MonoidalCategory {
  ...
  val productMonoidalCategory: MonoidalCategory[Function1, Tuple2, Unit] =
    new TupleMc {}
  ...
  val coproductMonoidalCategory: MonoidalCategory[Function1, Either, Void] =
  ...
  val productBraidedMonoidalCategory
      : BraidedMonoidalCategory[Function1, Either, Void] =
  ...
  val tupleBraidedMonoidalCategory
      : BraidedMonoidalCategory[Function1, Tuple2, Unit] =
    new BraidedMonoidalCategory[Function1, Tuple2, Unit] with TupleMc {
