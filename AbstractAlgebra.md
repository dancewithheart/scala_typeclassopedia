...
* Examples how to [define, use new instance](./src/test/scala/monoid/AlternativeMonoidInstancesSpec.scala), and [use zio-prelude instances](src/test/scala/semigroup/SemigroupExamplesSpec.scala).
